...
function Sparkline({ data, width = 550, height = 400 }) {
    ...
    const pathData = data
        .map((d, i) => {
            ...
            // --- MODIFICATION: Use fixed scale and clamp value ---
...
export function TrafficDensityCard({ density, status, history }) {
    ...
    return (
        <motion.div
            className="p-6 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl text-white overflow-hidden min-w-[45vw] min-h-[45vw] flex flex-col justify-around" 
